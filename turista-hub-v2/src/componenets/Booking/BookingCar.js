        ...
        <Form className='booking__info-form' onSubmit={handleClick}>
          ...
          <FormGroup>
           ...
           <FormGroup className='d-flex gap-3'>
                     <input  onKeyDown={(e) => e.preventDefault()} type='date' id='pickupDate' required min={new Date().toISOString().split('T')[0]} onChange={handleChange} />
                     <input  onKeyDown={(e) => e.preventDefault()} type='date' id='endDate' required min={new Date().toISOString().split('T')[0]} onChange={handleChange} />
                   </FormGroup>
          <FormGroup>
            {/* <input type='number' placeholder='Number of Rental Days' id='rentalDays' required onChange={handleChange} min={1} /> */}
           < p><strong>Rental Days:</strong> {booking.rentalDays} day(s)</p>          

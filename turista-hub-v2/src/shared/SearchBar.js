...
//     return alert('Please enter a valid positive distance')
// }

// if(isNaN(maxGroupSize) || maxGroupSize <= 0) {
//     return alert('Please enter a valid positive group size')
// }
...
//                 <div>
//                     <h6>Location</h6>
//                     <input type="text" placeholder='Where r u going'  ref={locationRef}/>
//                 </div>
//             </FormGroup>
